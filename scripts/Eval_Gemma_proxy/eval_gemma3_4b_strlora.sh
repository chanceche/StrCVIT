...
BASE_SCRIPT_DIR="<STRCVIT_METHODS_DIR>/scripts/Eval_Gemma_proxy"

if [ -z "$1" ]; then
  echo "Usage: bash eval_gemma3_4b_strlora.sh <task_id>"
  exit 1
fi

MODEL_DIR="$1/gemma3_4b_StrLoRA"
...
echo "Strategy: ${GPUS_PER_TASK} GPUs per task."
