...
def get_model_info_table():
    ...
    end_words = [['### Multimodal large models', '## Datasets']]
    result = [
        ...
        for group in model_meta.model_groups:
            for model in group.models:
                ...
                if model_meta.is_multimodal:
                    ...
                    res_llm.append(r)
    print(f'LLM count: {len(res_llm)}, MLLM count: {len(res_mllm)}')
    print(f'[Megatron] LLM count: {mg_count_llm}, MLLM count: {mg_count_mllm}')
    text = ['', '']  # llm, mllm
