...
def parse_args():
    ...
    parser.add_argument('--results', type=str, default="./results/StrCVIT/Qwen_New/ScienceQA/GQA/merge.jsonl")
    parser.add_argument('--questions', type=str, default='./playground/Instructions_slim/ScienceQA/test.json')
    parser.add_argument('--rule', default='<STRCVIT_METHODS_DIR>/swift/llm/eval/rule.json')
    parser.add_argument('--rule_temp', default='StrCVIT')
