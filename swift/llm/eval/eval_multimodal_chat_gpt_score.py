...
import swift.llm.eval.llm as llm
...
def main(args):
    answer_data = load_file_jsonl(args.answers_file)
    question_data = load_file_jsonl(args.question_file)
...
if __name__ == '__main__':
   ...
   parser.add_argument("--question-file", default="<STRCVIT_DATASET_DIR>/test/LLava_med/llava_med_eval_qa50_qa.jsonl", metavar="FILE", help="path to multichat questions file")
