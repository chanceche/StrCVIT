...
if __name__ == '__main__':
    ...
    results = {}
    results['AD'] = text_acc(os.path.join(args.result_dir, 'AD/Result.text'))
    results['Fin'] = text_acc(os.path.join(args.result_dir, 'Fin/Result.text'))
    results['RS'] = text_acc(os.path.join(args.result_dir, 'RS/Result.text'))
    ...
    results['Places'] = text_acc(os.path.join(args.result_dir, 'Places/Result.text'))
    results['TextCaps'] = cider_acc(os.path.join(args.result_dir, 'TextCaps_proxy/cider_result.txt'))
    results['OCRVQA'] = text_acc(os.path.join(args.result_dir, 'OCRVQA/Result.text'))
    results['Grounding'] = text_acc(os.path.join(args.result_dir, 'Grounding/Result.text'))
