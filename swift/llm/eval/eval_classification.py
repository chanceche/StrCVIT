...
def get_args():
    ...
    parser.add_argument('--result-file', type=str, default='./results/StrCVIT/Classification/merge.jsonl')
    parser.add_argument('--output-dir', type=str, default='./results/StrCVIT/Classification')
    ...
    for index in tqdm(range(total)):
        ...
        for text in text_list:
            if (text.upper() in label['text'].upper()) or (label['text'].upper() in text.upper()):
                ...
                label['ground_truth'].append(text)
