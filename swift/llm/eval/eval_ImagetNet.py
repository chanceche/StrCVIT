...
def get_args():
    ...
    parser.add_argument('--result-file', type=str, default='./results/StrCVIT/ImageNet/merge.jsonl')
    parser.add_argument('--output-dir', type=str, default='./results/StrCVIT/ImageNet')
