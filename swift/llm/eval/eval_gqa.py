...
#
#
# Upstream personal contact details are omitted from this public release.
# See the GQA dataset website for dataset information.
#
#
...
questions = loadFile(os.path.join('<STRCVIT_DATASET_DIR>/test/GQA', args.questions.format(tier = args.tier)))
