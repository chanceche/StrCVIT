...
class TunerArguments:
    ...
    train_aligner: bool = False
    lora_aligner: bool = False
    freeze_attn: bool = False
    freeze_textrouter: bool = False
    ...
    subtopk: Optional[int] = field(default=0)
    attn_proj_dim: Optional[int] = field(default=0)
    sample_router_distill_lambda: Optional[float] = field(default=0.0)
    sample_router_distill_beta: Optional[float] = field(default=0.999)
    sample_router_distill_tau: Optional[float] = field(default=1.0)
    freeze_qk: bool = False
    freeze_expo: bool = False
    # Vera
    vera_rank: int = 256
