...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/alpaca-gpt4-data-zh',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/LongAlpaca-12k',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/ruozhiba',
...
register_dataset(
    DatasetMeta(ms_dataset_id='AI-PublicHub/math-trn-format', preprocess_func=MathTrnPreprocessor(), tags=['math']))
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='public/MSAgent-Bench',
        subsets=[
            SubsetDataset(
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/firefly-train-1.1M',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/synthetic_text_to_sql',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/blossom-math-v2',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/sql-create-context',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/tigerbot-law-plugin',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/leetcode-solutions-python',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/hh-rlhf',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/hh_rlhf_cn',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/lmsys-chat-1m',
...
register_dataset(
    DatasetMeta(ms_dataset_id='AI-PublicHub/ultrafeedback-binarized-preferences-cleaned-kto', tags=['rlhf', 'kto']))
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/GuanacoDataset',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/function-calling-chatml',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/databricks-dolly-15k',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/orpo-dpo-mix-40k',
