...
class ShareGPT4oPreprocessor(MessagesPreprocessor):
    ...
    def prepare_dataset(self, dataset):
        if not use_hf_hub():
            url = ('https://www.modelscope.cn/api/v1/datasets/AI-PublicHub/ShareGPT-4o/repo?'
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/ShareGPT-4o',
...
class EmoSchemaPreprocessor(ResponsePreprocessor):
    ...
    def prepare_dataset(self, dataset: HfDataset) -> HfDataset:
        for i in range(1, 6):
            if not use_hf_hub():
                url = f'https://modelscope.cn/datasets/AI-PublicHub/egoschema/resolve/master/videos_chunked_0{i}.zip'
            else:
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/egoschema',
...
class MovieChat1KPreprocessor(ResponsePreprocessor):
    ...
    def prepare_dataset(self, dataset: HfDataset) -> HfDataset:
        ...
        for file in mp4_set:
            if not use_hf_hub():
                url = f'https://modelscope.cn/datasets/AI-PublicHub/MovieChat-1K-test/resolve/master/videos/{file}'
            else:
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/MovieChat-1K-test',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/M3IT',
        subsets=[
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/ShareGPT4V',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/LLaVA-Instruct-150K',
...
class LLaVAPretrainPreprocessor(MessagesPreprocessor):
    ...
    def prepare_dataset(self, dataset):
        if not use_hf_hub():
            url = ('https://www.modelscope.cn/api/v1/datasets/AI-PublicHub/LLaVA-Pretrain/repo?'
                   'Revision=master&FilePath=images.zip')
        else:
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/LLaVA-Pretrain',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/coco',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/LaTeX_OCR',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/captcha-images',
        split=['train', 'validation'],
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='AI-PublicHub/clevr_cogen_a_train',
