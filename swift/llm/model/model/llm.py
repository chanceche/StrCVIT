...
def get_model_tokenizer_grok(*args, **kwargs):
    tokenizer_dir = safe_snapshot_download('AI-PublicHub/grok-1-tokenizer', download_model=False, check_local=True)
    ...
    ModelMeta(
        ...
        [
            ModelGroup(
                [
                    # base
                    Model('public/nlp_polylm_13b_text_generation', 'Public-NLP-MT/polylm-13b'),
                ], ),
        ],
        TemplateType.default,
...
register_model(
    ModelMeta(
        LLMModelType.dbrx, [
            ModelGroup([
                Model('AI-PublicHub/dbrx-base', 'databricks/dbrx-base'),
                Model('AI-PublicHub/dbrx-instruct', 'databricks/dbrx-instruct'),
            ]),
        ],
        TemplateType.dbrx,
        get_model_tokenizer_with_flash_attn,
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('public/nlp_seqgpt-560m', 'Public-NLP/SeqGPT-560M'),
            ]),
        ],
        TemplateType.default,
        get_model_tokenizer_with_flash_attn,
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/c4ai-command-r-v01', 'CohereForAI/c4ai-command-r-v01'),
                Model('AI-PublicHub/c4ai-command-r-plus', 'CohereForAI/c4ai-command-r-plus'),
            ]),
        ],
        TemplateType.c4ai,
        get_model_tokenizer_with_flash_attn,
...
register_model(
    ModelMeta(
        LLMModelType.aya, [
            ModelGroup([
                Model('AI-PublicHub/aya-expanse-8b', 'CohereForAI/aya-expanse-8b'),
                Model('AI-PublicHub/aya-expanse-32b', 'CohereForAI/aya-expanse-32b'),
            ]),
        ],
        TemplateType.aya,
        get_model_tokenizer_with_flash_attn,
...
register_model(
    ModelMeta(
        LLMModelType.qwen2_gte, [
            ModelGroup([
                Model('iic/gte_Qwen2-1.5B-instruct', 'Public-NLP/gte-Qwen2-1.5B-instruct'),
                Model('iic/gte_Qwen2-7B-instruct', 'Public-NLP/gte-Qwen2-7B-instruct'),
            ]),
        ],
        None,
