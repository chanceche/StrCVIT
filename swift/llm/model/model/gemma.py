...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/paligemma-3b-pt-224', 'google/paligemma-3b-pt-224'),
                Model('AI-PublicHub/paligemma-3b-pt-448', 'google/paligemma-3b-pt-448'),
                Model('AI-PublicHub/paligemma-3b-pt-896', 'google/paligemma-3b-pt-896'),
            ]),
            ModelGroup([
                Model('AI-PublicHub/paligemma-3b-mix-224', 'google/paligemma-3b-mix-224'),
                Model('AI-PublicHub/paligemma-3b-mix-448', 'google/paligemma-3b-mix-448'),
            ]),
            ModelGroup([
                Model('AI-PublicHub/paligemma2-3b-pt-224', 'google/paligemma2-3b-pt-224'),
                Model('AI-PublicHub/paligemma2-3b-pt-448', 'google/paligemma2-3b-pt-448'),
                Model('AI-PublicHub/paligemma2-3b-pt-896', 'google/paligemma2-3b-pt-896'),
                Model('AI-PublicHub/paligemma2-10b-pt-224', 'google/paligemma2-10b-pt-224'),
                Model('AI-PublicHub/paligemma2-10b-pt-448', 'google/paligemma2-10b-pt-448'),
                Model('AI-PublicHub/paligemma2-10b-pt-896', 'google/paligemma2-10b-pt-896'),
                Model('AI-PublicHub/paligemma2-28b-pt-224', 'google/paligemma2-28b-pt-224'),
                Model('AI-PublicHub/paligemma2-28b-pt-448', 'google/paligemma2-28b-pt-448'),
                Model('AI-PublicHub/paligemma2-28b-pt-896', 'google/paligemma2-28b-pt-896'),
            ]),
            ModelGroup([
                Model('AI-PublicHub/paligemma2-3b-ft-docci-448', 'google/paligemma2-3b-ft-docci-448'),
                Model('AI-PublicHub/paligemma2-10b-ft-docci-448', 'google/paligemma2-10b-ft-docci-448'),
            ]),
        ],
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/gemma-2b-it', 'google/gemma-2b-it'),
                Model('AI-PublicHub/gemma-2b', 'google/gemma-2b'),
                Model('AI-PublicHub/gemma-7b', 'google/gemma-7b'),
                Model('AI-PublicHub/gemma-7b-it', 'google/gemma-7b-it'),
            ], ),
        ],
        TemplateType.gemma,
