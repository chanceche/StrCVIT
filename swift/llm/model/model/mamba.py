...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/mamba-130m-hf', 'state-spaces/mamba-130m-hf'),
                Model('AI-PublicHub/mamba-370m-hf', 'state-spaces/mamba-370m-hf'),
                Model('AI-PublicHub/mamba-390m-hf', 'state-spaces/mamba-390m-hf'),
                Model('AI-PublicHub/mamba-790m-hf', 'state-spaces/mamba-790m-hf'),
                Model('AI-PublicHub/mamba-1.4b-hf', 'state-spaces/mamba-1.4b-hf'),
                Model('AI-PublicHub/mamba-2.8b-hf', 'state-spaces/mamba-2.8b-hf'),
            ])
        ],
