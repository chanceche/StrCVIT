    ...
    if version == 'v2-4khd':
        ...
        def load_model(self):
            self.vision_tower_name = safe_snapshot_download(
                'AI-PublicHub/clip-vit-large-patch14-336', check_local=True)
    ...
    ModelMeta(
        ...
        [
            ModelGroup([
                ...
                Model('AI-PublicHub/InternVL-Chat-V1-5', 'OpenGVLab/InternVL-Chat-V1-5'),
                Model('AI-PublicHub/InternVL-Chat-V1-5-int8', 'OpenGVLab/InternVL-Chat-V1-5-int8'),
            ], ),
        ],
