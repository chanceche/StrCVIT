...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/llava-llama-3-8b-v1_1-transformers', 'xtuner/llava-llama-3-8b-v1_1-transformers'),
            ]),
        ],
...
def get_model_tokenizer_llava(model_dir: str,
    ...
    model_config.mm_vision_tower = safe_snapshot_download('AI-PublicHub/clip-vit-large-patch14-336', check_local=True)
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/llama3-llava-next-8b', 'lmms-lab/llama3-llava-next-8b'),
            ], ),
        ],
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/llava-v1.6-mistral-7b', 'liuhaotian/llava-v1.6-mistral-7b'),
            ], ),
        ],
...
register_model(
    ModelMeta(
        MLLMModelType.llava1_6_yi, [
            ModelGroup([
                Model('AI-PublicHub/llava-v1.6-34b', 'liuhaotian/llava-v1.6-34b'),
            ], ),
        ],
...
register_model(
    ModelMeta(
        MLLMModelType.llava_next_qwen, [
            ModelGroup([
                Model('AI-PublicHub/llava-next-72b', 'lmms-lab/llava-next-72b'),
                Model('AI-PublicHub/llava-next-110b', 'lmms-lab/llava-next-110b'),
            ], ),
        ],
