...
register_model(
    ModelMeta(
        ...
        [
            ...
            ModelGroup([
                # base
                Model('AI-PublicHub/chinese-llama-2-1.3b', 'hfl/chinese-llama-2-1.3b'),
                Model('AI-PublicHub/chinese-llama-2-7b', 'hfl/chinese-llama-2-7b'),
                Model('AI-PublicHub/chinese-llama-2-7b-16k', 'hfl/chinese-llama-2-7b-16k'),
                Model('AI-PublicHub/chinese-llama-2-7b-64k', 'hfl/chinese-llama-2-7b-64k'),
                Model('AI-PublicHub/chinese-llama-2-13b', 'hfl/chinese-llama-2-13b'),
                Model('AI-PublicHub/chinese-llama-2-13b-16k', 'hfl/chinese-llama-2-13b-16k'),
                # chat
                Model('AI-PublicHub/chinese-alpaca-2-1.3b', 'hfl/chinese-alpaca-2-1.3b'),
                Model('AI-PublicHub/chinese-alpaca-2-7b', 'hfl/chinese-alpaca-2-7b'),
                Model('AI-PublicHub/chinese-alpaca-2-7b-16k', 'hfl/chinese-alpaca-2-7b-16k'),
                Model('AI-PublicHub/chinese-alpaca-2-7b-64k', 'hfl/chinese-alpaca-2-7b-64k'),
                Model('AI-PublicHub/chinese-alpaca-2-13b', 'hfl/chinese-alpaca-2-13b'),
                Model('AI-PublicHub/chinese-alpaca-2-13b-16k', 'hfl/chinese-alpaca-2-13b-16k'),
            ]),
            # base quant
            ModelGroup([
                Model('AI-PublicHub/Llama-2-7b-AQLM-2Bit-1x16-hf', 'ISTA-DASLab/Llama-2-7b-AQLM-2Bit-1x16-hf'),
            ],
...
register_model(
    ModelMeta(
        ...
        [
            ...
            # nvidia Nemotron
            ModelGroup([
                Model('AI-PublicHub/Llama-3.1-Nemotron-70B-Instruct-HF', 'nvidia/Llama-3.1-Nemotron-70B-Instruct-HF'),
            ])
        ],
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/NuminaMath-7B-TIR', 'AI-MO/NuminaMath-7B-TIR'),
            ]),
        ],
        TemplateType.numina,
        get_model_tokenizer_with_flash_attn,
