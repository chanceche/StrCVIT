...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/Idefics3-8B-Llama3', 'HuggingFaceM4/Idefics3-8B-Llama3'),
            ]),
        ],
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/pixtral-12b', 'mistral-community/pixtral-12b'),
            ]),
        ],
...
register_model(
    ModelMeta(
        MLLMModelType.qwen2_gme, [
            ModelGroup([
                Model('iic/gme-Qwen2-VL-2B-Instruct', 'Public-NLP/gme-Qwen2-VL-2B-Instruct'),
                Model('iic/gme-Qwen2-VL-7B-Instruct', 'Public-NLP/gme-Qwen2-VL-7B-Instruct'),
            ]),
        ],
