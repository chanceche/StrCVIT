...
register_model(
    ModelMeta(
        ...
        [
            # llama2
            ModelGroup([
                Model('AI-PublicHub/Florence-2-base-ft', 'microsoft/Florence-2-base-ft'),
                Model('AI-PublicHub/Florence-2-base', 'microsoft/Florence-2-base'),
                Model('AI-PublicHub/Florence-2-large', 'microsoft/Florence-2-large'),
                Model('AI-PublicHub/Florence-2-large-ft', 'microsoft/Florence-2-large-ft'),
            ]),
        ],
...
register_model(
    ModelMeta(
        ...
        [
            ModelGroup([
                Model('AI-PublicHub/phi-2', 'microsoft/phi-2'),
            ]),
        ],
