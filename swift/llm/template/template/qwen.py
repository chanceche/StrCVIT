...
qwq_preview_system = 'You are a helpful and harmless assistant. You should think step-by-step.'
...
register_template(
    QwenTemplateMeta(
        ...
        default_system=('You are a helpful and harmless assistant. Answer in the language of the question. '
