...
from .tuners.strlora import StrLoRAConfig
...
MODEL_TYPE_TO_PEFT_MODEL_MAPPING = {
    ...
    "CAUSAL_LM_STRLORA": PeftModelForCausalLMLORAMOE,
    "CAUSAL_LM_SMoLoRA": PeftModelForCausalLMLORAMOE,
    "CAUSAL_LM_MOELORA": PeftModelForCausalLMLORAMOE,
}
